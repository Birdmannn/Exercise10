...
public class SimpleInterpreter {
     ...
     */
    public static void doLetCommand() throws ParseError {
        TextIO.skipBlanks();
     ...
     */
    public static void doPrintCommand() throws ParseError {
     ...
     */
    public static double expressionValue() throws ParseError {
        TextIO.skipBlanks();
     ...
     */
    public static double termValue() throws ParseError {
        TextIO.skipBlanks();
     ...
     * on line 222 with "if".)
     */
    public static double factorValue() throws ParseError {
        TextIO.skipBlanks();
     ...
     */
    public static double primaryValue() throws ParseError {
        TextIO.skipBlanks();
        char ch = TextIO.peek();
        if ( Character.isDigit(ch) ) {
            ...
            if(obj instanceof StandardFunction) {
                ...
                if(TextIO.peek() == '(') {
                    ...
                    TextIO.skipBlanks();
                    if(TextIO.peek() != ')')
                        throw new ParseError("Parenthesis after function missing.");
                    TextIO.getChar();

                    return ((StandardFunction) symbolTable.get(name)).evaluate(value);
                }
                else
                    throw new ParseError("No parenthesis found.");
